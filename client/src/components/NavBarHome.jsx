            ...
            <div className="relative">
              ...
              {userDropdown && (
                <div className="absolute right-0 mt-2 w-44 border border-red-800 rounded-xl shadow-lg z-50 animate-fade-in">
                  <button
                    className="w-full flex items-center gap-2 px-4 py-3 text-red-200 hover:bg-white hover:text-white hover:shadow-lg hover:border hover:border-red-400 duration-200 font-semibold rounded-t-xl"
